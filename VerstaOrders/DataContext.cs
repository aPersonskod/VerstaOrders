...
public sealed class DataContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Order>().HasData(
            new Order(new Guid("a582d854-2216-42b7-95b9-c9b2c2d7d669"), "ORD-0520260001", "Москва", "ул. Тверская, д. 10", "Санкт-Петербург", "Невский пр., д. 25", 15.5m, new DateTime(2026, 05, 22).ToUniversalTime()),
            new Order(new Guid("5c5759c6-4b4e-4150-bbe0-912c1c8f8c34"), "ORD-0520260002", "Казань", "ул. Баумана, 5", "Екатеринбург", "пр. Ленина, 100", 8.2m, new DateTime(2026, 05, 22).ToUniversalTime()),
